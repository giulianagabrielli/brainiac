    ...
    return (
        <div className="table">
            ...
            >
                ...
                <Column caption="E-mail" dataField="email" dataType="string" width="32%" />
                <Column caption="Password" dataField="password" dataType="string" width="32%" />
                <Column caption="Created at" dataField="created_at" dataType="date" width="32%" />
